...
# 输入文件路径
input_csv_file = r'C:\project\python\pythonProject\re\keti\dataset\herb pairs for training\all herb pairs for training1.txt'
...
# 保存结果到文件
output_file = os.path.join(output_dir, 'HCGCN-all herb pairs1.cites')
