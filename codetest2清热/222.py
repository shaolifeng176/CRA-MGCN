...
model.load_state_dict(torch.load(r'C:\project\python\pythonProject\re\keti\codetest2清热\model_fold9_best.pth'))
model.eval()
...
for i in range(1, 644):
    try:
        ...
        output_file = fr'C:\project\python\pythonProject\re\keti\codetest2清热\output\predictions{i}.csv'
...
# 保存合并后的数据
merged_output_file = r'C:\project\python\pythonProject\re\keti\codetest2清热\output\merged_predictions9.csv'
