...
parser.add_argument('--epochs', type=int, default=10000, help='训练轮次')
...
if __name__ == "__main__":
    ...
    for fold in range(5):
        ...
        adj, features, labels, idx_train, idx_test = load_data(
            path=r'C:\project\python\pythonProject\re\keti\codetest2调气\training data\\',
            dataset='HCGCN-qi-regulating herb pairs',
            fold=fold
        )
