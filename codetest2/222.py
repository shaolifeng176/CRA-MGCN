...
model.load_state_dict(torch.load(r'C:\project\python\pythonProject\re\keti\codetest2\model_fold0_best.pth'))
model.eval()
...
# 保存合并后的数据
merged_output_file = r'C:\project\python\pythonProject\re\keti\codetest2\output\merged_predictions111.csv'
