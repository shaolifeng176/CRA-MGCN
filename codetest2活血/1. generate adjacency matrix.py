...
# 输入文件路径
input_csv_file = r'C:\project\python\pythonProject\re\keti\dataset\herb pairs for training\blood-activating herb pairs for training.txt'

# 读取药对
herb_pairs = read_herb_pairs_from_csv(input_csv_file)

# 输出目录
output_dir = r'C:\project\python\pythonProject\re\keti\codetest2活血\training data\\'
...
# 保存结果到文件
output_file = os.path.join(output_dir, 'HCGCN-blood-activating herb pairs.cites')
