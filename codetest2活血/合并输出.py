...
model.load_state_dict(torch.load(r'C:\project\python\pythonProject\re\keti\codetest2\model_fold9_best.pth'))
model.eval()
...
for i in range(1, 644):
    try:
        ...
        # 选择需要的列
        filtered_df = filtered_df[['Source_File', 'Original_Index', 'Predicted_Class', 'Probability']]
...
# 保存合并后的数据
merged_output_file = r'C:\project\python\pythonProject\re\keti\codetest2\output\merged_predictions9.csv'
